...
const HeroBanner = () => {
    ...
    return (
        <div
            id="hero"
            className="w-full h-[100vh] relative bg-[#1a967f] overflow-hidden"
        >
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>yadavshashank0907@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4 text-2xl">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Shashank Yadav</span>
                    </div>
                    <div className="max-w-[510px]">
                        I create and maintain websites.
                    </div>
                </motion.div>
                {/* INTRO END */}
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                        <div className="text-[80px] font-light">05+</div>

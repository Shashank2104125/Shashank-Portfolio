...
const Skills = () => {
    ...
    return (
        ...
        >
            <Div className="text-[40px] md:text-[90px] 1xl:text-[120px] leading-[52px] md:leading-[95px] 2xl:leading-[123px] font-oswald uppercase mb-[25px] md:mb-[40px] 2xl:mb-[60px] flex flex-col px-10 relative">
                <span>Skills</span>
            </Div>
            {/* <span className="
                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            ...
                            desc="With over 1 year of experience, I specialize in frontend development, creating visually appealing and interactive user interfaces. I have a strong understanding of HTML, CSS, and JavaScript, ensuring seamless website functionality and optimal user experience."
                            data={[
                                "Responsive Web Design",
                                "Frontend Frameworks (React, Next)",
                                "CSS Preprocessors (Tailwind, Bootstrap)",
                                "Version Control (Git)",
                        ...
                        <Service
                            ...
                            desc="With over 1 year of experience, I specialize in backend development using Node.js and Express.js. I have a strong proficiency in working with databases like MongoDB and Firebase, creating robust and scalable server-side solutions."
                            data={[
                        ...
                        <Service
                            num="3"
                            title="UI/UX Design"
                            desc="As a UI/UX designer, I specialize in creating visually appealing and intuitive user interfaces. With a strong foundation in design principles and user-centered thinking, I leverage tools like Figma and LocoFy to craft engaging and delightful experiences for users."
                            data={[
